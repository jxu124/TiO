...
from .dataset_tio import TiODataset
...
class InvigTask(OFATask):
    def __init__(self, cfg: InvigConfig, src_dict, tgt_dict):
        ...
        self.tio_config = TiOConfig(self.cfg.config_yaml)
    ...
    def _inference(self, generator, sample, model):
        ...
        sbbox_gen = self.tokenizer.batch_decode([h[0]['tokens'] for h in gen_out])
        sbbox_gt = self.tokenizer.batch_decode(sample['target'])
