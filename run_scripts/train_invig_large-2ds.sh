...
# ==== 训练数据 ====
data=${PATH_D_DATASET}/invig_train.jsonl,${PATH_D_DATASET}/guesswhat_train.jsonl,${PATH_D_DATASET}/invig_valid.jsonl
restore_file=${PATH_D_CHECKPOINTS}/ofa_large.pt
selected_cols=0

# ==== 日志参数 ====
log_dir=${PATH_D_LOG}/invig_large-2ds_logs
save_dir=${PATH_D_LOG}/invig_large-2ds_checkpoints
