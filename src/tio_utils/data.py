...
"""
# 【制作】 image_processor & tokenizer
pretrain_path = "OFA-Sys/ofa-huge"
save_path = "/mnt/bn/hri-lq/huggingface_hub"
tokenizer = transformers.BartTokenizer.from_pretrained(pretrain_path, truncation_side="right")
tokenizer.add_tokens(["<code_{}>".format(i) for i in range(8192)])
tokenizer.add_tokens(["<bin_{}>".format(i) for i in range(1000)])
tokenizer.save_pretrained(save_path)
image_processor = transformers.ConvNextImageProcessor(size=512, resample=Image.Resampling.BICUBIC)
